...
public class CustomerControllerTest {
	...
	@Test
	public void customer_testRegisterCustomer() throws Exception {
	...
	@Test
	public void customer_testRegisterCustomerIsServiceMethodCalled() throws Exception {
	...
	@Test
	public void customer_testGetAllCustomers() throws Exception {
	...
	@Test
	public void customer_testGetAllCustomersIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<CustomerDto> customerDtos = MasterData.getCustomerDtoList();
	...
	@Test
	public void customer_testGetCustomerById() throws Exception {
		CustomerDto customerDto = MasterData.geCustomerDto();
	...
	@Test
	public void customer_testGetCustomersByIdIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		CustomerDto customerDto = MasterData.geCustomerDto();
	...
	@Test
	public void customer_testUpdateCustomer() throws Exception {
		CustomerDto customerDto = MasterData.geCustomerDto();
		CustomerDto savedCustomerDto = MasterData.geCustomerDto();
		savedCustomerDto.setId(1L);
	...
	@Test
	public void customer_testUpdateCustomerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		CustomerDto customerDto = MasterData.geCustomerDto();
		CustomerDto savedCustomerDto = MasterData.geCustomerDto();
		savedCustomerDto.setId(1L);
	...
	@Test
	public void customer_testDeleteCustomer() throws Exception {
		CustomerDto customerDto = MasterData.geCustomerDto();
		customerDto.setId(1L);
	...
	@Test
	public void customer_testDeleteCustomerIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		CustomerDto customerDto = MasterData.geCustomerDto();
		customerDto.setId(1L);
	...
	@Test
	public void customer_testPlaceBid() throws Exception {
	...
	@Test
	public void customer_testPlaceBidIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		BidsDto bidsDto = MasterData.getBidsDto();
		bidsDto.setId(1L);
	...
	@Test
	public void customer_testGetAllBidsOnProductAfterEndDate() throws Exception {
	...
	@Test
	public void customer_testGetAllBidsOnProductAfterEndDateIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<BidsDto> bidsDtos = MasterData.getBidsDtoList();
