...
public class ProductControllerTest {
	...
	@Test
	public void product_testSaveProduct() throws Exception {
	...
	@Test
	public void product_testRegisterProductIsServiceMethodCalled() throws Exception {
	...
	@Test
	public void product_testGetAllProducts() throws Exception {
	...
	@Test
	public void product_testGetAllProductsIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<ProductDto> productDtos = MasterData.getProductDtoList();
	...
	@Test
	public void product_testGetProductById() throws Exception {
		ProductDto productDto = MasterData.getProductDto();
	...
	@Test
	public void product_testGetProductsByIdIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		ProductDto productDto = MasterData.getProductDto();
	...
	@Test
	public void product_testUpdateProduct() throws Exception {
		ProductDto productDto = MasterData.getProductDto();
		ProductDto savedProductDto = MasterData.getProductDto();
	...
	@Test
	public void product_testUpdateProductIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		ProductDto productDto = MasterData.getProductDto();
		ProductDto savedProductDto = MasterData.getProductDto();
		savedProductDto.setProductId(1L);
	...
	@Test
	public void product_testDeleteProduct() throws Exception {
		ProductDto productDto = MasterData.getProductDto();
		productDto.setProductId(1L);
	...
	@Test
	public void product_testDeleteProductIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		ProductDto productDto = MasterData.getProductDto();
		productDto.setProductId(1L);
	...
	@Test
	public void product_testGetAllProductsBySeller() throws Exception {
		List<ProductDto> productDtos = MasterData.getProductDtoList();
	...
	@Test
	public void product_testGetAllProductsBySellerIdIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<ProductDto> productDtos = MasterData.getProductDtoList();
	...
	@Test
	public void product_testGetAllProductsByCategory() throws Exception {
		List<ProductDto> productDtos = MasterData.getProductDtoList();
	...
	@Test
	public void product_testGetAllProductsByCategoryIsServiceMethodCalled() throws Exception {
		final int count[] = new int[1];
		List<ProductDto> productDtos = MasterData.getProductDtoList();
