...
public class CustomerExceptionTest {
	...
	@Test
	public void customer_testRegisterCustomerInvalidDataException() throws Exception {
	...
	@Test
	public void customer_testUpdateCustomerInvalidDataException() throws Exception {
		CustomerDto customerDto = MasterData.geCustomerDto();
		CustomerDto savedCustomerDto = MasterData.geCustomerDto();
	...
	@Test
	public void customer_testGetCustomerByIdCustomerNotFoundException() throws Exception {
	...
	@Test
	public void customer_testDeleteCustomerByIdCustomerNotFoundException() throws Exception {
		ExceptionResponse exResponse = new ExceptionResponse("Customer with Id - 1 not Found!", System.currentTimeMillis(),
				HttpStatus.NOT_FOUND.value());
