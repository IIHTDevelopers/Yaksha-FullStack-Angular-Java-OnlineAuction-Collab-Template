...
public class ProductExceptionTest {
	...
	@Test
	public void product_testSaveProductInvalidDataException() throws Exception {
	...
	@Test
	public void product_testUpdateProductInvalidDataException() throws Exception {
		ProductDto productDto = MasterData.getProductDto();
		ProductDto savedProductDto = MasterData.getProductDto();
	...
	@Test
	public void product_testGetProductByIdProductNotFoundException() throws Exception {
	...
	@Test
	public void product_testDeleteProductByIdProductNotFoundException() throws Exception {
		ExceptionResponse exResponse = new ExceptionResponse("Product with Id - 1 not Found!", System.currentTimeMillis(),
				HttpStatus.NOT_FOUND.value());
